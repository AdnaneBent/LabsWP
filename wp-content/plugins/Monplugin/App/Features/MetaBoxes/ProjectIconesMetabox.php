...
class ProjectIconesMetabox
{
    public static $slug = 'project_icones_metabox';
    /**
    ...
    public static function add_meta_box()
    {
        ...
        add_meta_box(
            self::$slug,           // Unique ID
            __("Icones pour les project"),  // Box title
    ...
    public static function render()
    {
        ...
        $icone = extract_data_attr('icone_choice', $data);
        ...
        view('metaboxes/project-icone', compact('icone'));
    }
    ...
    public static function save($post_id)
    {
        ...
        if (count($_POST) != 0) {
            ...
            $icone_register = $_POST['icone_choice'];
            // https://developer.wordpress.org/reference/functions/update_post_meta/
            update_post_meta($post_id, 'icone_choice', $icone_register);
        }
    }
}
